...
<head>
    ...
    <title>Ads Money | App Version Number</title>
...
<script>
    $("li[role='menu_li']:eq(17)").addClass("active");
            ...
            if (!postData || !id) {
                ...
                switch (action) {
                    case 'create':
                        $.ajax( {
                            type: 'POST',
                            url:  'app_version_number/create_app_version',
                            data: postData,
                            dataType: "json",
                    ...
                    case 'edit':
                        $.ajax( {
                            type: 'POST',
                            url:  'app_version_number/update_app_version',
                            data: postData,
                            dataType: "json",
                            success: function (json) {
                                success( json );
                    ...
                    case 'remove':
                        $.ajax( {
                            type: 'POST',
                            url:  'app_version_number/delete_app_version',
                            data: postData,
                            dataType: "json",
                            success: function (json) {
                                if (json.ret == 1) {
    ...
    $('#appTable').DataTable({
        ...
        "ajax": function (data, callback, settings) {
            ...
            $.post("app_version_number/query_app_version", postData, function (data) {
                if (data && data.ret == 1) {
                    var list = [];
