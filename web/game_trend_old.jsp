...
<head>
    ...
    <title>Ads Money | Game Trend(Old)</title>
                ...
                <div class="box-body" style="overflow-x: auto">
                    <table id="metricTable" class="table table-bordered table-hover" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th>PurchasedUser</th>
                            <th>Installed</th>
                            <th>Installed用户开局数目</th>
                            <th>Installed用户胜局数目</th>
                            <th>Installed用户开局总平均数</th>
                            <th>Installed用户胜局总平均数</th>
                            <th>TotalUser</th>
                            <th>ActiveUser</th>
                            <th>Active用户开局数目</th>
                            <th>Active用户胜局数目</th>
                            <th>Active用户开局总平均数</th>
                            <th>Active用户胜局总平均数</th>
                            <th>Revenue</th>
                            <th>CPA</th>
                            <th>ECPM</th>
                            <th>CPA/ECPM</th>
...
<script>
    ...
    function queryData() {
        ...
        var columns = [
            ...
            {data: 'total_user'},
            {data: 'active_user'},
            {data: 'activeUserRoundStartCount'},
            {data: 'activeUserRoundWinCount'},
            {data: 'avgSumActiverRoundStart'},
            {data: 'avgSumActiverRoundWin'},
            {data: 'revenue'},
//            {data: 'arpu'},
//            {data: 'arpu_trend'},
            {data: 'cpa'},
