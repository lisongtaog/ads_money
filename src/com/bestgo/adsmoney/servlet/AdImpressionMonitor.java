            ...
            if (path.startsWith("/query")) {
                ...
                try {
                    String sql = "select date, app_id, sum(total_user) as total_user, sum(active_user) as active_user, " +
                            ...
                            "sum(five_native_ad_user) as five_native_ad_user " +
                        ...
                        public int compare(AppAdImpressionMetrics o1, AppAdImpressionMetrics o2) {
                            ...
                            switch (orderIndex) {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    ret = (o1.activeUser > 0 ? o1.adUser * 1.0 / o1.activeUser : 0) - (o2.activeUser > 0 ? o2.adUser * 1.0 / o2.activeUser : 0);
                                    break;
                                case 6:
                    ...
                    for (int i = index; i < resultList.size() && i < (index + size); i++) {
                        ...
                        jsonObject.addProperty("ad_user_rate", formatRate(one.adUser, one.activeUser));
